<!--
 * @Author: shaohang-shy
 * @Date: 2024-01-31 17:04:44
 * @LastEditors: shaohang-shy
 * @LastEditTime: 2024-01-31 17:04:44
 * @Description: BoxBorder09
-->
...
<template>
  <div ref="boxRef" class="border-box-9">
    <svg class="border-svg-container" :width="width" :height="height">
        ...
        <linearGradient :id="state.gradientId" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="0%" stop-color="{props.colors[0]}">
            <animate
              ...
              :values="`${props.colors[0]};${props.colors[1]};${props.colors[0]}`"
              dur="10s"
              begin="0s"
              repeatCount="indefinite"
            />
          ...
          <stop offset="100%" stop-color="{props.colors[1]}">
            <animate
              attributeName="stop-color"
              :values="`${props.colors[1]};${props.colors[0]};${props.colors[1]}`"
              dur="10s"
              begin="0s"
              repeatCount="indefinite"
            />
      ...
      <polygon
        :fill="props.backgroundColor" :points="`
...
.border-box-9 .border-svg-container {
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0px;
...
.border-box-9 .border-box-content {
  position: relative;
  width: 100%;
  height: 100%;
}
