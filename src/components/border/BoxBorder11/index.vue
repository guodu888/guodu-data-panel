...
const filterId = `border-box-11-filterId-${id}`
</script>

<template>
  <div ref="boxRef" class="border-box-11">
    <svg class="border-svg-container" :width="width" :height="height">
      <defs>
        <filter :id="filterId" height="150%" width="150%" x="-25%" y="-25%">
          <feMorphology operator="dilate" radius="2" in="SourceAlpha" result="thicken" />
          <feGaussianBlur in="thicken" stdDeviation="3" result="blurred" />
          <feFlood :flood-color="props.colors[1]" result="glowColor" />
...
.border-box-11 .border-svg-container {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0px;
...
.border-box-11 .border-svg-container  > polyline {
  fill: none;
  stroke-width: 1;
}
.border-box-11 .border-box-content {
  position: relative;
  width: 100%;
  height: 100%;
}
